...
6. **Install Dependencies**
   Once you are in the correct folder, run the following command in the command prompt:
   ```
   npm install
   ```
   This command installs all necessary dependencies for the application to work properly.
...
7. **Start the Application**
   ...
   npm run dev
   ```
   After a moment, the command prompt will show a local web address, usually `http://localhost:3000`. Open this address in your web browser to view the Memory Bottle application.

## 🔍 Features
- **Memory Timeline**: Create and manage a personal timeline of memories.
- **Media Upload**: Easily upload photos and videos to accompany your memories.
- **User-Friendly Interface**: Designed to be simple and intuitive, even for non-technical users.
- **Responsive Design**: Works seamlessly on various devices, ensuring access to memories anywhere.

## 📌 System Requirements
To ensure the best experience while using Memory Bottle, please make sure your system meets the following requirements:
- **Operating System**: Windows 10 or later, macOS 10.12 or later, or a modern Linux distribution.
- **Browser**: Latest version of Chrome, Firefox, Safari, or Edge.
- **Connectivity**: A stable internet connection for initial setup and media uploads.
...
- **GitHub Issues**: Use the “Issues” tab in this repository for reporting bugs or asking for features.
- **Documentation**: Additional help and detailed guides may be available in the repository's Wiki section.
